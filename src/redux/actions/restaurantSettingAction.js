...
export const getAllRestaurantDetail=()=>{
    return async(dispatch)=>{
        try{
            ...
            dispatch({type:"GET_RESTAURANTSETTING_SUCCESS",payload:response.data});
        }
        catch(error){
  ...
  export const updateRestaurantInfoDetail=(data)=>{
    return async(dispatch)=>{
        try{
            ...
            dispatch({type:"UPDATE_RESTAURANTINFO_SUCCESS",payload:response.data});
...
export const updateRestaurantProfileImage=(image)=>{
  return async(dispatch)=>{
      try{
          ...
          dispatch({type:"UPDATE_RESTAURANTPROFILEIMAGE_SUCCESS",payload:response.data});
          dispatch(getAllRestaurantDetail());
...
export const updateRestaurantCoverImage=(image)=>{
  return async(dispatch)=>{
      try{
          ...
          let response = await Axios.put(dataURL,formData,config );
          dispatch({type:"UPDATE_RESTAURANTCOVERIMAGE_SUCCESS",payload:response.data});
          dispatch(getAllRestaurantDetail());
          dispatch(setAlert('Profile Image Updated Successfuly', 'success'));
      }
      catch(error){
  ...
  return async(dispatch)=>{
      try{
        ...
        formData.append("type", type);
          ...
          let response = await Axios.put(dataURL,formData,config );
          dispatch({type:"UPLOAD_RESTAURANTGALLERYIMAGE_SUCCESS",payload:response.data});
          dispatch(getAllRestaurantDetail());
...
export const deleteRestaurantGalleryImage=(data)=>{
  return async(dispatch)=>{
      try{
          ...
          dispatch({type:"DELETE_RESTAURANTGALLERYIMAGE_SUCCESS",payload:response.data});
          dispatch(getAllRestaurantDetail());
          dispatch(setAlert('Restaurant Info Updated Successfuly', 'success'));
      }
      catch(error){
