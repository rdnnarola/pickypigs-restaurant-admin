    ...
    return async(dispatch)=>{
        try{
            ...
            let config= {
             ...
             formData.append("createNewVersion", JSON.stringify(data.createNewVersion));
             formData.append("ingredientSection", JSON.stringify(data.ingredientSection));
             formData.append("caloriesAndMacros", JSON.stringify(data.caloriesAndMacros));
