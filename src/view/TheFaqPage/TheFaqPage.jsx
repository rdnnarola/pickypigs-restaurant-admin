                    ...
                    <div className="row mt-4 mb-5">
                        <div className="col-sm-12 mb-3">
                            <div className="searchfaq-input position-relative ml-auto mr-auto">
                                <input placeholder="Search FAQ" type="text" className="input-search form-control" />
                                <div className="search-icon">
                                    <img src={search_grey} className="img-fluid" />
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <h2 class="mb-0 w-100">
                                            <button class="btn btn-link btn-block text-dark text-decoration-none faq-btn text-left pl-0 pr-0 d-flex justify-content-between align-items-center position-relative" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                ...
                                                <div className="faq-arrow arrow-down">
                                                    <img width="14" src={down_arrow} className="img-fluid" />
                                                </div>
                                            </button>
                                        </h2>
                                    </div>
