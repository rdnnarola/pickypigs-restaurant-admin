  ...
  return (
    <>
      <nav className="navbar fixed-top navbar-expand-lg navbar-light bg-white navbar-admin p-0">
        ...
        <div
          className="collapse navbar-collapse nav-collapse  align-items-center"
        ...
        >
          ...
          <div className="d-flex align-items-center nav-rigthcontent">
            ...
            <NavLink
              to="/manage_dishes"
              className="btn pinkline-btn text-uppercase rounded-pill mr-4 w-170 f-15"
              style={{
                display: "flex",
