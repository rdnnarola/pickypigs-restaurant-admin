...
const RestaurantSecurityComp = (props) => {
  ...
  const initialValues = {
    ...
    twoFactorAuthenticationPhoneNumber: twoFactorAuthenticationPhoneNumber
      ? twoFactorAuthenticationPhoneNumber
      : false,
    twoFactorAuthenticationEmail: twoFactorAuthenticationEmail
      ? twoFactorAuthenticationEmail
      : false,
  };
  ...
  const onSubmit = (fields) => {
    ...
    if (fields.password) {
      obj = {
        ...
        twoFactorAuthenticationPhoneNumber:
          fields.twoFactorAuthenticationPhoneNumber,
                                    ...
                                    <input
                                      ...
                                      className={` ${
                                        editForm
                                          ...
                                          : "form-control-inputtext form-control"
                                      }`}
                                      value="password"
                                    />
                                  </div>
                                  ...
                                  <div className="col-sm-12 d-flex flex-wrap">
                                    <React.Fragment>
                                      {values.twoFactorAuthenticationPhoneNumber && (
                                        <h5 className="f-15 gray-txt mb-0 mr-4">
                                          * Two factor authentication by phone
                                          number
                                        </h5>
                                      )}
                                    </React.Fragment>
                                    <React.Fragment>
                                      {values.twoFactorAuthenticationEmail && (
                                        <h5 className="f-15 gray-txt mb-0">
                                  ...
                                  <div className="col-sm-12 d-flex flex-wrap">
                                    <div className="checkbox-setting custom-control custom-checkbox pink-checkbox mr-5">
                                      <Field
                                        ...
                                        id="twoFactorAuthenticationPhoneNumber"
                                        className="custom-control-input"
                                      />
                                      <label
                                        className="custom-control-label gray-control-label f-15"
                                        htmlFor="twoFactorAuthenticationPhoneNumber"
                                      >
                                        Two factor authentication by phone
                                        number
                                      </label>
                                    ...
                                    <div className="checkbox-setting custom-control custom-checkbox pink-checkbox">
                                      ...
                                      <label
                                        className="custom-control-label gray-control-label f-15"
                                        htmlFor="twoFactorAuthenticationEmail"
                                      >
                                        Two factor authentication by email
                                      </label>
                                    </div>
