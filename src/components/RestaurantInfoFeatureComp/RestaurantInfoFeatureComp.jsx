...
const RestaurantInfoFeatureComp = (props) => {
  ...
  const handleCuisineType = (e, cuisine, setFieldValue) => {
    ...
    if (cuisine.indexOf(e.target.id) !== -1) {
      ...
      if (Index > -1) {
        setFieldValue(
          "cuisineType",
          cuisine.filter((mycuisine) => mycuisine !== e.target.id)
        );
      }
    } else {
  ...
  const initialValues = {
    averageCostOfTwoPerson:
      props.featuredata && props.featuredata.averageCostOfTwoPerson
        ? averageCostOfTwoPerson
        : "",
    cardAccept:
      props.featuredata && props.featuredata.cardAccept ? cardAccept : false,
    cashAccept:
      props.featuredata && props.featuredata.cashAccept ? cashAccept : false,
    inclusiveTaxesAndCharges:
      props.featuredata && props.featuredata.inclusiveTaxesAndCharges
        ? inclusiveTaxesAndCharges
        : false,
    cuisineType:
      props.featuredata && props.featuredata.cuisineType
        ? props.featuredata.cuisineType.filter(
            (val) =>
              cuisine_Data &&
              cuisine_Data.data &&
              cuisine_Data.data.map((data) => data._id).includes(val)
          )
        : [],
    restaurantFeaturesOptions:
      props.featuredata && props.featuredata.restaurantFeaturesOptions
        ? props.featuredata.restaurantFeaturesOptions.filter(
            (val) =>
        ...
        : [],
    appliesOfRestaurant:
      props.featuredata && props.featuredata.appliesOfRestaurant
        ? appliesOfRestaurant
        : [],
  ...
  const validationSchema = Yup.object().shape({
    averageCostOfTwoPerson: Yup.string().matches(
      numbRegs,
      "Invalid Cost Per TWo Person"
    ),
                          ...
                          >
                            <div className="accordion-body ">
                                ...
                                <div className="col-sm-12">
                                  {editForm ? (
                                    <div className="d-flex flex-wrap pl-0">
                                      <p className="f-15 mb-4 brandon-Medium">
                                        Average cost for two persons (approx.)
                                      </p>

                                      <React.Fragment>
                                        {values.averageCostOfTwoPerson ? (
                                          <div className="col-sm-12 pl-0">
                                            <p className="f-15 brandon-Medium mb-2 ">
                                              Min $
                                              {values.averageCostOfTwoPerson}
                                            </p>
                                          </div>
                                      ...
                                      <React.Fragment>
                                        {values.inclusiveTaxesAndCharges && (
                                          <div className="col-sm-12 pl-0">
                                            <p className="f-13 gray-txt mr-4 mb-2 ">
                                              *Inclusive taxes and charges if
                                              any
                                            </p>
                                          </div>
                                        )}
                                    ...
                                    <div className="d-flex flex-wrap pl-0 mb-3">
                                      <p className="f-15 mb-2 brandon-Medium">
                                        Provide below average cost for two
                                        persons (approx.)
                                      </p>
                                      <div className="col-sm-12 d-flex flex-wrap align-items-center mt-3 pl-0 approx-costinput-wrapper">
                                        <div className="pl-0 approx-costinput position-relative mr-5">
                                          <div className="input-doller-sing">
                                            $
                                          </div>
                                          <Field
                                            name="averageCostOfTwoPerson"
                                            type="number"
                                            placeholder="$"
                                            className="form-control-input form-control "
                                          />
                                          {touched.averageCostOfTwoPerson &&
                                            errors.averageCostOfTwoPerson && (
                                        ...
                                        <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                          <Field
                                            type="checkbox"
                                            name="inclusiveTaxesAndCharges"
                                            id="inclusiveTaxesAndCharges"
                                            className="custom-control-input"
                                          />
                                          <label
                                            className="custom-control-label gray-control-label f-15"
                                            htmlFor="inclusiveTaxesAndCharges"
                                          >
                                            Inclusive taxes and charges if any
                                          </label>
                                        </div>
                                        <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                          <Field
                              ...
                              <div className="row mt-2">
                                <div className="col-sm-12">
                                  <p className="f-15 mb-4 brandon-Medium">
                                    Select cuisine type from below options
                                  </p>
                                  <div className="option-tag-main d-flex flex-wrap">
                                    {cuisine_Data &&
                                      cuisine_Data.data &&
                                      cuisine_Data.data.map((data, index) => {
                                        return (
                                              ...
                                              <React.Fragment>
                                                <button
                                                  ...
                                                  className={`option-tag mr-4 mb-4 ${
                                                    ...
                                                    props.featuredata
                                                      .cuisineType &&
                                                    props.featuredata.cuisineType.indexOf(
                                                      data._id
                                                    ) !== -1 &&
                                                    "active"
                                                  }`}
                                                ...
                                                <React.Fragment>
                                                  <button
                                                    ...
                                                    className={`option-tag mr-4 mb-4 ${
                                                      ...
                                                      props.featuredata
                                                        .restaurantFeaturesOptions &&
                                                      props.featuredata.restaurantFeaturesOptions.indexOf(
                                                        data._id
                                                      ) !== -1 &&
                                                      "active"
                                                    }`}
                              ...
                              <div className="row mt-2">
                                {editForm ? (
                                  <div className="col-sm-12">
                                    <h5 className="f-15 mb-4 brandon-Medium">
                                      What other features does your venue have?
                                    </h5>
                                    {props.featuredata &&
                                    props.featuredata.appliesOfRestaurant &&
                                    props.featuredata.appliesOfRestaurant
                                      .length > 0 ? (
                                      props.featuredata &&
                                      props.featuredata.appliesOfRestaurant.map(
                                        (data, index) => {
                                          return (
                                            <React.Fragment key={index}>
                                              <p className="form-control-plaintext gray-txt">
                                  ...
                                  <React.Fragment>
                                    <div className="col-sm-12">
                                      ...
                                      <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 position-relative mb-2 mt-2 pl-0 pr-0 selectapplies-wrapper custom-lightinputbox">
                                        <Field
                                          name="appliesOfRestaurant2"
                                          placeholder="Enter here"
                                          className="form-control-input form-control position-relative"
                                        />
                                        <button
                                          type="button"
                                          onClick={() => {
                                            handleInputBoxDataUpdate(
                                              values.appliesOfRestaurant2,
                                              values.appliesOfRestaurant,
                                              setFieldValue,
                                              "appliesOfRestaurant"
                                            );
                                            setFieldValue(
                                    ...
                                    <div className="col-sm-12 selectapplies-tag d-flex align-items-center flex-wrap">
                                      {values.appliesOfRestaurant.length ===
                                        0 &&
                                        errors.appliesOfRestaurant && (
                                          <div className="error pink-txt f-11">
                                            {errors.appliesOfRestaurant}
                                          </div>
                                        )}
                                      {values &&
                                        values.appliesOfRestaurant.map(
                                          (data, index) => {
                                            return (
                                              <React.Fragment key={index}>
