...
import { deleteSelectedDishesData } from "../../redux/actions/dishesAction";

import './DeleteDishesModalComp.scss';



const DeleteDishesModalComp = (props) => {
  const dispatch=useDispatch();
    const handleDelete=()=>{
        dispatch(deleteSelectedDishesData(props.selectedid));
        props.onHide();
    }
    return (
        <>
...
export default DeleteDishesModalComp;