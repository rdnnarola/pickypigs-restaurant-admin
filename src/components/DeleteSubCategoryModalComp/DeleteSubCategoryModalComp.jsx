...
import {deleteSelectedSubCategoryData} from "../../redux/actions/subcategoryAction";

import './DeleteSubCategoryModalComp.scss';



const DeleteSubCategoryModalComp = (props) => {
...
export default DeleteSubCategoryModalComp;