...
import {
  addSubMenuData,
  getSelectedSubMenuData,
  updateSelectedSubMenuData,
} from "../../redux/actions/submenuAction";
...
const AddEditSubMenuModalComp = (props) => {
  ...
  let initialValues2 = {
    ...
    parentMenu:
      menuData &&
      menuData.menuDetails.find((o) => o._id === subMenuData.parentMenu)
        ? subMenuData.parentMenu
        : "",
  };
                ...
                <Form>
                  <div>
                    ...
                    <div className="custom-drodown form-group ">
                      ...
                      {touched.parentMenu && errors.parentMenu && (
