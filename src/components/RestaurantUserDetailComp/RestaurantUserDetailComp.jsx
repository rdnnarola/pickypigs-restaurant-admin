                            ...
                            <div class="accordion-body ">
                                ...
                                <div className="row mb-4">
                                    <div className="col-md-6">
                                        <h5>ADMIN</h5>
                                        <input type="text" readOnly={editForm}  class={` ${editForm?"form-control-plaintext":"form-control-inputtext"}`} name="admin" onChange={handleChange} value={editRestInfo.admin}/>
                                    </div>
                                    <div className="col-md-6">
                                        <h5>USER NAME</h5>
                                        <input type="text" readOnly={editForm}  class={` ${editForm?"form-control-plaintext":"form-control-inputtext"}`} name="name" onChange={handleChange} value={editRestInfo.name}/>
                                    </div>
                                </div>
                                <div className="row mb-4">
                                    <div className="col-md-6">
