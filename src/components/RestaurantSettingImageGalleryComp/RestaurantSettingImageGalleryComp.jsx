                          ...
                          >
                            <div className="accordion-body ">
                              ...
                              <div className="row">
                                <div className="col-sm-12">
                                  <p className="f-15 mb-2 brandon-Medium">
                                    Add Food Images to your gallery
                                  </p>
                                </div>
                                {!editForm ? (
                                  <div className="col-sm-12">
                                      ...
                                      <div className="form-group">
                                        <div className="fileUpload">
                                          <input
                                            ...
                                            onChange={(e) => {
                                              galleryImageUploadHandeler(
                                                e,
                                                "Food"
                                              );
                                            }}
                                          />
                                          <span className="brandon-Medium">
                                            Upload Image
                                          </span>
                                        </div>
                                      </div>
                              ...
                              <div className="row mt-1">
                                <div className="col-sm-12">
                                  <div className="uploadyour-wrapper d-flex flex-wrap">
                                    {props.gallerydata &&
                                    props.gallerydata.food &&
                                    props.gallerydata &&
                                    props.gallerydata.food.length > 0 ? (
                                      props.gallerydata &&
                                      props.gallerydata.food.map(
                                        (data, index) => {
                                          return (
                                            <React.Fragment key={index}>
                                              <div className="uploadyour-block position-relative mr-3 mb-3">
                                                <img
                                                  ...
                                                  alt=""
                                                  className="img-fluid bg-white border p-1 position-relative"
                                                />
                                                {editForm ? null : (
                                                  <div className="overlay-close">
                                                    <button
                                                      className="position-absolute uploadyour-close"
                                                      onClick={() => {
                                                        handleRemoveImage(
                                                          data._id,
                                                          "Food"
                              ...
                              <div className="row">
                                <div className="col-sm-12">
                                  <p className="f-15 mb-2 brandon-Medium">
                                    Add Ambient images to your gallery
                                  </p>
                                </div>
                                {!editForm ? (
                                  <div className="col-sm-12">
                              ...
                              <div className="row mt-1">
                                <div className="col-sm-12">
                                  <div className="uploadyour-wrapper d-flex flex-wrap">
                                    {props.gallerydata &&
                                    props.gallerydata.ambience &&
                                    props.gallerydata &&
                                    props.gallerydata.ambience.length > 0 ? (
                                      props.gallerydata &&
                                      props.gallerydata.ambience.map(
                                        (data, index) => {
                                          return (
                                            <React.Fragment key={index}>
                                              <div className="uploadyour-block position-relative mr-3 mb-3">
                                                <img
                                                  ...
                                                  src={`${SERVER_URL}/${data.url}`}
                                                  alt=""
                                                  className="img-fluid bg-white p-1 position-relative"
                                                />
                                                {editForm ? null : (
                                                  <div className="overlay-close">
                                                    <button
