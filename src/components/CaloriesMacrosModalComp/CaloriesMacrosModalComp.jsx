    ...
    return (
        <>
            <section className="CaloriesMacrosModalComp-comp">
                ...
                <Modal backdrop="static" centered className="mainmodal-wrapper" show={show} onHide={handleClose} animation={false} >
                                        ...
                                        <Form>
                                            <React.Fragment>
                                                ...
                                                <div className="total-fat d-flex justify-content-between flex-wrap mt-3">
                                                    ...
                                                    <p scope="col" className="txt-lightgray fw-400 text-right pl-0 pr-0 pt-1 pb-1 border-top-0">
                                                            <div className="recipt-editwraper d-flex align-items-center justify-content-end input-dark">
                                                    ...
                                                    <table className="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td scope="col" className="txt-lightgray fw-400 text-right pl-0 pr-0 pt-1 pb-1 border-top-0">
                                                                    <div className="recipt-editwraper d-flex align-items-center justify-content-end input-dark">
                                                                        <Field name="cholesterol.percentage" className="mg-input" placeholder="00.00" /><b>%</b>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td scope="col" className="txt-lightgray fw-400 text-right pl-0 pr-0 pt-1 pb-1 border-top-0">
                                                                    <div className="recipt-editwraper d-flex align-items-center justify-content-end input-dark">
                                                                        <Field name="sodium.percentage" className="mg-input" placeholder="00.00" /><b>%</b>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td scope="col" className="txt-lightgray fw-400 text-right pl-0 pr-0 pt-1 pb-1 border-top-0">
                                                                    <div className="recipt-editwraper d-flex align-items-center justify-content-end input-dark">
                                                                        <Field name="totalCarbohydrate.totalPercentage" className="mg-input" placeholder="00.00" /><b>%</b>
                                                                    </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td scope="col" className="txt-lightgray fw-400 text-right pl-0 pr-0 pt-1 pb-1 border-top-0">
                                                                    <div className="recipt-editwraper d-flex align-items-center justify-content-end input-dark">
                                                                        <Field name="protien.totalPercentage" className="mg-input" placeholder="00.00" /><b>%</b>
                                                                    </div>
                                                ...
                                                <button type="reset" onClick={() => { handleCancleEdit(resetForm); }}>cancle</button>
