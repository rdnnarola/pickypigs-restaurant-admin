...
import {deleteSelectedSubMenuData} from "../../redux/actions/submenuAction"
import './DeleteSubMenuModalComp.scss';



const DeleteSubMenuModalComp = (props) => {
  const dispatch=useDispatch();
    const handleDelete=()=>{
        dispatch(deleteSelectedSubMenuData(props.selectedid,props.showDeleted));
        props.onHide();
    }
    return (
        <>
...
export default DeleteSubMenuModalComp;