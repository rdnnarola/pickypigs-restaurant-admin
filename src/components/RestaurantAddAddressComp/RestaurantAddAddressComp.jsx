...
const RestaurantAddAddressComp = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getGoogleAddressData(props.addressdata && props.addressdata.googleAddress)
    );
  ...
  const initialValues = {
    ...
    myPincode:
      Restaurant_Location && Restaurant_Location.postalcode
        ? Restaurant_Location && Restaurant_Location.postalcode
        : "",
    myStreet:
      Restaurant_Location && Restaurant_Location.streetName
        ? Restaurant_Location && Restaurant_Location.streetName
        : "",
    myLocality:
      Restaurant_Location && Restaurant_Location.localityData
        ? Restaurant_Location && Restaurant_Location.localityData
        : "",
    myGoogleAddress:
      Restaurant_Location && Restaurant_Location.address_Data
        ? Restaurant_Location && Restaurant_Location.address_Data
        : "",
  };
  ...
  const validationSchema = Yup.object().shape({
    ...
    myPincode: Yup.number().required(
      "Pincode is required. Please set a more precise location!"
    ),
    ...
    myStreet: Yup.string().required(
      "Street Name is required. Please set a more precise location!"
    ),
    myLocality: Yup.string().required(
      "Street Name is required. Please set a more precise location!"
    ),
  });
  const onSubmit = (fields) => {
    let obj = {
      ...
      map: {
        type: "point",
        coordinates:
          Restaurant_Location && Restaurant_Location.coordinate_data.split(","),
      },
    };
                            ...
                            <div className="accordion-body ">
                              ...
                              <div className="row mb-4">
                                <div className="col-md-6">
                                  <div className="rs-info-block">
                                    ...
                                    {editForm ? (
                                      props.addressdata &&
                                      props.addressdata.googleAddress ? (
                                      ...
                                      <React.Fragment>
                                        <Field
                                          name="myGoogleAddress"
                                          readOnly={true}
                                          placeholder="Enter Address here"
                                          className="form-control-inputtext form-control"
                                        />
                                        {touched.myGoogleAddress &&
                                          errors.myGoogleAddress && (
                              ...
                              <div className="row mb-4 pt-2">
                                {editForm ? (
                                  <div className="col-sm-12">
                                    {props.addressdata &&
                                    props.addressdata.addLocationMap ? (
                                      <h5 className="accordion-label f-15 gray-txt mb-0">
                                        * Location Map added
                                      </h5>
                                    ) : (
                                      <h5 className="accordion-label f-15 gray-txt mb-0">
                              ...
                              <div className="row">
                                {editForm ? null : values.addLocationMap ? (
                                  <React.Fragment>
                                    {Restaurant_Location &&
