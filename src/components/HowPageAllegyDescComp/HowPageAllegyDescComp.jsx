...
const alergy_information = [
  { name: "Egg", image: Nonveg_icon },
            ...
            <div className="row">
              <div className="col-sm-12">
                ...
                <div className="allergen-btn-wrapper d-flex align-items-start flex-wrap">
                  {alergy_information &&
                    alergy_information.map((data, index) => {
                      return (
                        <div
                          onClick={(e) => {
                            handleClick(e);
                  ...
                  <React.Fragment>
                    <div className="bg-white allergens-modal">
                      ...
                      <div className="allergens-info">
                        <p className="mb-0">
                          Gluten is the name of a family of proteins found in
                          wheat, barley, rye and oats. It is often found in
                          foods containing flour and therefore bread, baked
                          goods, cereals and pasta. It can also be found in
                          barleybased products such as beer, malt, malt vinegar
                          and food colouring.
                        </p>
                      </div>
                    </div>
            ...
            <div className="row">
              <div className="col-sm-12 mt-2">
                ...
                <div className="dietary-wrapper d-flex flex-wrap">
                  {dietary_preference &&
                    dietary_preference.map((data, index) => {
                      return (
            ...
            <div className="row">
              <div className="col-sm-12 mt-3">
                ...
                <div className="lifestyle-wrapper d-flex flex-wrap">
                  {lifestyle_choice &&
                    lifestyle_choice.map((data, index) => {
                      return (
                        <React.Fragment key={index}>
                          <button className="tags-btn mr-4 mb-4">{data}</button>
                        </React.Fragment>
            ...
            <div className="row">
              <div className="col-sm-12 mt-3">
                ...
                <div className="rsfeatures-wrapper d-flex flex-wrap">
                  {restaurant_features &&
                    restaurant_features.map((data, index) => {
                      return (
                        <React.Fragment key={index}>
                          <button className="tags-btn mr-4 mb-4">
                            {data}{" "}
                          </button>
                        </React.Fragment>
                      );
