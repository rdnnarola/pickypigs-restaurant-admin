...
const DaySelectorCheckBoxAutoCompleteComp = ({
  placeholder,
  clearAll,
  labelKey = "name",
  valueKey = "_myId",
              ...
              <Form>
                <div className="mb-2 ml-2">
                  <Form.Check
                    ...
                    className={
                      allSelected
                        ? "option selected filter-listcheck filterdrop-checkbox text-capitalize "
                        : "option filter-listcheck filterdrop-checkbox text-capitalize"
                    }
                    onClick={toggleSelectAll}
                    onKeyPress={toggleSelectAll}
                    custom
