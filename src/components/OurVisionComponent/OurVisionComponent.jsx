          ...
          <div className="row">
            <div className="col-sm-12 pl-0 pr-0">
              <div className="ourmission-wrapper">
                <h1 className="sectionhead-txt text-uppercase text-white brandon-Bold">
                  Our Mission{" "}
                </h1>
                <p className="ourmission-subtxt f-15 line-height-1_75 text-white">
                  Es ist ein lang erwiesener Fakt, dass ein Leser vom Text
                  abgelenkt wird, wenn er sich ein{" "}
                  <br className="d-lg-block d-none" /> Layout ansieht. Der
                  Punkt, Lorem Ipsum zu nutzen, ist, dass es mehr oder weniger
                  die
                </p>
          ...
          <div className="row">
            <div className="col-sm-12 pl-0 pr-0">
              ...
              <p className="join-subtxt f-15 line-height-1_75 text-white mb-4 pb-2">
                Es ist ein lang erwiesener Fakt, dass ein Leser vom Text
                abgelenkt wird, wenn er sich ein{" "}
                <br className="d-lg-block d-none" /> Layout ansieht. Der Punkt,
