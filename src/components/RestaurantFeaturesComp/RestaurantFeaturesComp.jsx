                                                        ...
                                                        <div className="accordion-body ">
                                                                ...
                                                                {editForm
                                                                    ...
                                                                    <div className="col-sm-12 mb-4 d-flex flex-wrap">
                                                                        <div className="custom-control custom-checkbox pink-checkbox mr-4 pr-2">
                                                                            ...
                                                                            <label className="custom-control-label gray-control-label f-15" htmlFor="isTime24Hours">Set the time format in 24h (eg: 15:30)</label>
                                                                        </div>
                                                                        <div className="custom-control custom-checkbox pink-checkbox">
                                                                            ...
                                                                            <label className="custom-control-label gray-control-label f-15" htmlFor="isMultiTime">Multi time</label>
                                                                        </div>
                                                                    </div>   
                                                                }
                                                            </div>
                                                                        ...
                                                                        <div>
                                                                            {values.timeArray&&values.timeArray.map((data,index)=>{
                                                                                return(
                                                                                    <React.Fragment key={index}>
                                                                                        <div className="opening-month-time d-flex align-items-center flex-wrap mb-3">
                                                                                            <div className="custom-control custom-checkbox pink-checkbox mr-4" style={{width:120}}>
                                                                                                <Field type="checkbox" name={`timeArray.${index}.isSelected`} id={data.day}  className="custom-control-input"/>
                                                                                                <label className="custom-control-label gray-control-label f-15" htmlFor={data.day}>{data.day}</label>
                                                                                            </div>
                                                            ...
                                                            <div className="row mt-2">
                                                                <div className="col-sm-12 mb-2">
                                                                    <p className="f-15 mb-2 brandon-Medium">Website (optional)</p>
                                                                        <div>
                                                                            {editForm?
                                                                                <div>
                                                                                            ...
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        ...
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.websiteUrl,setFieldValue,"websiteUrl")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
                                                                        ...
                                                                        {editForm
                                                                            ...
                                                                            <div className="col-sm-12 d-flex flex-wrap mt-3">
                                                                                <div className="custom-control custom-checkbox pink-checkbox pl-2">
                                                                ...
                                                                <div className="col-sm-12 mb-2">
                                                                    <p className="f-15 mb-2 brandon-Medium">Bookings</p>
                                                                        ...
                                                                        {editForm
                                                                            ...
                                                                            :
                                                                            <div className="col-sm-12 d-flex flex-wrap mt-3">
                                                                                <div className="custom-control custom-checkbox pink-checkbox pl-2 mr-4">
                                                                                    <Field type="checkbox" name="isAvailable" id="isAvailable"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isAvailable">Available</label>
                                                                                </div>
                                                                                <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                                                                    <Field type="checkbox" name="isWebsite" id="isWebsite"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isWebsite">Website</label>
                                                                                </div>
                                                                                <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                                                                    <Field type="checkbox" name="isEmail" id="isEmail"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isEmail">Email</label>
                                                                                </div>
                                                                                <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                                                                    <Field type="checkbox" name="isCall" id="isCall"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isCall">Call</label>
                                                                                </div>
                                                                            </div>   
                                                                        }
                                                                        <div className="mt-4">
                                                                            ...
                                                                            :
                                                                                <React.Fragment >
                                                                                    <p className="gray-txt f-15 mb-0">Provide URL (your own website or third party website</p>
                                                                                    <div className="position-relative mb-2 mt-2">
                                                                                        <Field name="bookingswebsiteUrl2" placeholder="http://" className="form-control-input form-control w-50"/>
                                                                                        {}
                                                                                        <button type="button" 
                                                                                        ...
                                                                                        values&&values.bookingswebsiteUrl.map((data,index)=>{
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        <p className="f-16 mb-1">{data}</p>
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.bookingswebsiteUrl,setFieldValue,"bookingswebsiteUrl")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
                                                                        ...
                                                                        <div className="mt-4">
                                                                            ...
                                                                            :
                                                                                <React.Fragment >
                                                                                    <p className="gray-txt f-15 mb-0">Provide Email</p>
                                                                                    <div className="position-relative mb-2 mt-2">
                                                                                        ...
                                                                                        values&&values.bookingsemail.map((data,index)=>{
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        <p className="f-16 mb-1">{data}</p>
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.bookingsemail,setFieldValue,"bookingsemail")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
                                                                                        ...
                                                                                        values&&values.bookingsphoneNumber.map((data,index)=>{
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        <p className="f-16 mb-1">{data}</p>
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.bookingsphoneNumber,setFieldValue,"bookingsphoneNumber")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
                                                                ...
                                                                <div className="col-sm-12 mb-2">
                                                                    <p className="f-15 mb-2 brandon-Medium">Social Media</p>
                                                                        ...
                                                                        {editForm
                                                                            ...
                                                                            <div className="col-sm-12 d-flex flex-wrap mt-3">
                                                                                <div className="custom-control custom-checkbox pink-checkbox pl-2 mr-4">
                                                                                    ...
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isSocialAvailable">Available</label>
                                                                                </div>
                                                                                <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                                                                    <Field type="checkbox" name="isFacebook" id="isFacebook"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isFacebook">Facebook</label>
                                                                                </div>
                                                                                <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                                                                    <Field type="checkbox" name="isTwitter" id="isTwitter"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isTwitter">Twitter</label>
                                                                                </div>
                                                                                <div className="custom-control custom-checkbox pink-checkbox mr-4">
                                                                                    <Field type="checkbox" name="isInstagram" id="isInstagram"  className="custom-control-input"/>
                                                                                    <label className="custom-control-label gray-control-label f-15" htmlFor="isInstagram">Instagram</label>
                                                                                </div>
                                                                            </div>   
                                                                        }
                                                                        <div className="mt-4">
                                                                            ...
                                                                            :
                                                                                <React.Fragment >
                                                                                    <p className="gray-txt f-15 mb-0">Facebook</p>
                                                                                    <div className="position-relative mb-2 mt-2">
                                                                                        <Field name="facebookUrl2" placeholder="http://" className="form-control-input form-control w-50"/>
                                                                                        {}
                                                                                        <button type="button" 
                                                                                        ...
                                                                                        values&&values.facebookUrl.map((data,index)=>{
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        <p className="f-16 mb-1">{data}</p>
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.facebookUrl,setFieldValue,"facebookUrl")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
                                                                        ...
                                                                        <div className="mt-4">
                                                                            ...
                                                                            :
                                                                                <React.Fragment >
                                                                                    <p className="gray-txt f-15 mb-0">Twitter</p>
                                                                                    <div className="position-relative mb-2 mt-2">
                                                                                        ...
                                                                                        values&&values.twitterUrl.map((data,index)=>{
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        <p className="f-16 mb-1">{data}</p>
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.twitterUrl,setFieldValue,"twitterUrl")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
                                                                        ...
                                                                        <div className="mt-4">
                                                                            ...
                                                                            :
                                                                                <React.Fragment >
                                                                                    <p className="gray-txt f-15 mb-0">Instagram</p>
                                                                                    <div className="position-relative mb-2 mt-2">
                                                                                        <Field name="instagramUrl2" placeholder="http://" className="form-control-input form-control w-50"/>
                                                                                        {}
                                                                                        <button type="button" 
                                                                                        ...
                                                                                        values&&values.instagramUrl.map((data,index)=>{
                                                                                            return(
                                                                                                <React.Fragment key={index}>
                                                                                                    <div className="d-flex flex-wrap justify-content-between align-items-center">
                                                                                                        <p className="f-16 mb-1">{data}</p>
                                                                                                        <button type="button" onClick={()=>{handleInputBoxDataRemove(data,values.instagramUrl,setFieldValue,"instagramUrl")}}>x</button>
                                                                                                    </div>
                                                                                                </React.Fragment>
                                                                                            )
                                                                                        }) 
