...
const RestaurantFeaturesComp = (props) => {
  ...
  const initialValues = {
    websiteUrl:
      website && website.websiteUrl ? website && website.websiteUrl : [],
    websiteUrl2: "",
    isAddToProfilePage:
      website && website.isAddToProfilePage
        ? website && website.isAddToProfilePage
        : false,

    isTime24Hours:
      openingTimings && openingTimings.isTime24Hours
        ? openingTimings && openingTimings.isTime24Hours
        : false,
    isMultiTime:
      openingTimings && openingTimings.isMultiTime
        ...
        : false,
    timeArray:
      openingTimings && openingTimings.time
        ? openingTimings && openingTimings.time
        : [
            {
              day: "Sunday",
    ...
    isAvailable:
      bookings && bookings.isAvailable
        ? bookings && bookings.isAvailable
        : false,
    isWebsite:
      bookings && bookings.isWebsite ? bookings && bookings.isWebsite : false,
    isEmail:
      bookings && bookings.isEmail ? bookings && bookings.isEmail : false,
    isCall: bookings && bookings.isCall ? bookings && bookings.isCall : false,
    bookingswebsiteUrl:
      bookings && bookings.websiteUrl ? bookings && bookings.websiteUrl : [],
    bookingswebsiteUrl2: "",
    bookingsemail: bookings && bookings.email ? bookings && bookings.email : [],
    bookingsemail2: "",
    bookingsphoneNumber:
      bookings && bookings.phoneNumber ? bookings && bookings.phoneNumber : [],
    bookingsphoneNumber2: "",

    isSocialAvailable:
      socialMedia && socialMedia.isAvailable
        ? socialMedia && socialMedia.isAvailable
        : false,
    isFacebook:
      socialMedia && socialMedia.isFacebook
        ? socialMedia && socialMedia.isFacebook
        : false,
    isTwitter:
      socialMedia && socialMedia.isTwitter
        ? socialMedia && socialMedia.isTwitter
        : false,
    isInstagram:
      socialMedia && socialMedia.isInstagram
        ? socialMedia && socialMedia.isInstagram
        : false,
    facebookUrl:
      socialMedia && socialMedia.facebookUrl
        ? socialMedia && socialMedia.facebookUrl
        : [],
    facebookUrl2: "",
    twitterUrl:
      socialMedia && socialMedia.twitterUrl
        ? socialMedia && socialMedia.twitterUrl
        : [],
    twitterUrl2: "",
    instagramUrl:
      socialMedia && socialMedia.instagramUrl
        ? socialMedia && socialMedia.instagramUrl
        : [],
    instagramUrl2: "",
  };
  ...
  const validationSchema = Yup.object().shape({
    ...
    bookingsphoneNumber2: Yup.string().matches(
      numbRegs,
  ...
  const handleInputBoxDataRemove = (data, values, setFieldValue, filed) => {
    setFieldValue(
      filed,
      values.filter((myallergy) => myallergy !== data)
    );
  };
                        ...
                        <div className="accordion-item">
                          ...
                          >
                            <div className="accordion-body ">
                              ...
                              <div className="row">
                                <div className="col-sm-12">
                                  <p className="f-15 mb-2 brandon-Medium">
                                    Opening Timings
                                  </p>
                                </div>
                                {editForm ? (
                                  <div className="col-sm-12 d-flex flex-wrap">
                                    <React.Fragment>
                                      {values.isTime24Hours && (
                                        <p className="f-13 gray-txt mr-4">
                                  ...
                                  <div className="col-sm-12 mb-4 d-flex flex-wrap">
                                    <div className="checkbox-setting custom-control custom-checkbox pink-checkbox mr-5">
                                      ...
                                      />
                                      <label
                                        className="custom-control-label gray-control-label f-13"
                                        htmlFor="isTime24Hours"
                                      >
                                        Set the time format in 24h (eg: 15:30)
                                      </label>
                                    </div>
                              ...
                              <div className="row">
                                <div className="col-sm-12">
                                  {editForm ? (
                                    props.detaildata &&
                                    props.detaildata.openingTimings &&
                                    props.detaildata.openingTimings.time &&
                                    props.detaildata.openingTimings.time.map(
                                      (data, index) => {
                                        return (
                                          <div key={index}>
                                            {data.isSelected && (
                                              <React.Fragment key={index}>
                                                <div className="opening-month-time d-flex align-items-center flex-wrap mb-3">
                                                  ...
                                                  <div style={{ width: 100 }}>
                                                    <p className="f-15 mb-0 brandon-Medium">
                                                      {data.day}
                                                    </p>
                                                  </div>
                                                  <div
                                                    className={`timeing-main-wrapper d-flex align-items-center ${
                                                      data.isSelected &&
                                                      "active"
                                                    }`}
                                                  >
                                                    <React.Fragment>
                                                      <div
                                                        className="custom-timepicker mb-0 form-group d-flex align-items-center"
                                                        style={{ width: 90 }}
                                                      >
                                                        <MuiPickersUtilsProvider
                                                          utils={MomentUtils}
                                                        >
                                                          <TimePicker
                                                            ...
                                                            ampm={
                                                              !openingTimings.isTime24Hours
                                                            }
                                                            disabled={true}
                                                            value={`Thu Dec 31 2020 ${
                                                              data.timeList &&
                                                              data.timeList[0]
                                                                .startTime
                                                            } `}
                                                      ...
                                                      <div className="timeing-dash"></div>
                                                      <div
                                                        className="custom-timepicker mb-0 form-group d-flex align-items-center"
                                                        style={{ width: 90 }}
                                                      >
                                    ...
                                    <div>
                                      {values.timeArray &&
                                        values.timeArray.map((data, index) => {
                                          return (
                                            <React.Fragment key={index}>
                                              <div className="opening-month-time d-flex align-items-center flex-wrap mb-3">
                                                <div
                                                  className="checkbox-setting custom-control custom-checkbox pink-checkbox mr-4"
                                                  style={{ width: 120 }}
                                                >
                                                  <Field
                                                    type="checkbox"
                                                    name={`timeArray.${index}.isSelected`}
                                                    id={data.day}
                                                    className="custom-control-input"
                                                  />
                                                  <label
                                                    className="custom-control-label gray-control-label f-15"
                                                    htmlFor={data.day}
                                                  >
                                                    {data.day}
                                                  </label>
                                                          ...
                                                          >
                                                            <KeyboardTimePicker
                                                              ...
                                                              onChange={(
                                                                ...
                                                                setFieldValue(
                                                                  `timeArray.${index}.timeList.${0}.startTime`,
                                                                  moment(
                                                                    date
                                                                  ).format(
                                                                    "HH:mm"
                                                          ...
                                                          >
                                                            <KeyboardTimePicker
                                                              ...
                                                              onChange={(
                                                                ...
                                                                setFieldValue(
                                                                  `timeArray.${index}.timeList.${0}.endTime`,
                                                                  moment(
                                                                    date
                                                                  ).format(
                                                                    "HH:mm"
                                                            ...
                                                            >
                                                              <KeyboardTimePicker
                                                                ...
                                                                onChange={(
                                                                  ...
                                                                  setFieldValue(
                                                                    `timeArray.${index}.timeList.${1}.startTime`,
                                                                    moment(
                                                                      date
                                                                    ).format(
                                                                      "HH:mm"
                                                            ...
                                                            >
                                                              <KeyboardTimePicker
                                                                ...
                                                                onChange={(
                                                                  ...
                                                                  setFieldValue(
                                                                    `timeArray.${index}.timeList.${1}.endTime`,
                                                                    moment(
                                                                      date
                                                                    ).format(
                                                                      "HH:mm"
                              ...
                              <div className="row mt-2">
                                <div className="col-sm-12 mb-2">
                                  <p className="f-15 mb-3 brandon-Medium">
                                    Website (optional)
                                  </p>
                                  <div className="row">
                                    {editForm ? (
                                      <div className="col-sm-12">
                                        {website &&
                                        website.websiteUrl &&
                                        website.websiteUrl.length > 0 ? (
                                          website &&
                                          website.websiteUrl.map(
                                            (data, index) => {
                                              return (
                                                <React.Fragment key={index}>
                                                  <p className="form-control-plaintext gray-txt">
                                                    {data}
                                                  </p>
                                                </React.Fragment>
                                              );
                                      ...
                                      <React.Fragment>
                                        <div className="col-sm-12 position-relative">
                                          <div className="addinput-control custom-lightinputbox position-relative">
                                            <Field
                                              name="websiteUrl2"
                                              placeholder="http://"
                                              className="form-control-input form-control f-15"
                                            />
                                            <button
                                              type="button"
                                              onClick={() => {
                                                handleInputBoxDataUpdate(
                                                  values.websiteUrl2,
                                                  values.websiteUrl,
                                                  setFieldValue,
                                                  "websiteUrl"
                                              ...
                                              className="add-trans-button f-15"
                                              disabled={
                                                !values.websiteUrl2 ||
                                                errors.websiteUrl2
                                              }
                                        ...
                                        <div className="col-sm-12">
                                          {touched.websiteUrl2 &&
                                            errors.websiteUrl2 && (
                                              <div className="error pink-txt f-11 mb-2">
                                                {errors.websiteUrl2}
                                              </div>
                                            )}
                                        </div>
                                  ...
                                  {editForm ? (
                                    <div className="col-sm-12 pl-0">
                                      <React.Fragment>
                                        {values.isAddToProfilePage && (
                                          <p className="f-13 gray-txt mr-4 mb-0">
                                    ...
                                    <div className="col-sm-12 mt-2">
                                      <div className="checkbox-setting custom-control custom-checkbox pink-checkbox pl-2">
                                        <Field
                                          type="checkbox"
                                          name="isAddToProfilePage"
                                          id="isAddToProfilePage"
                                          className="custom-control-input"
                                        />
                                        <label
                                          className="custom-control-label gray-control-label f-15"
                                          htmlFor="isAddToProfilePage"
                                        >
                                          Add to profile page
                                        </label>
                                      </div>
                              ...
                              <div className="row mt-2">
                                <div className="col-sm-12 mb-2">
                                  ...
                                  <div className="mt-4">
                                    {editForm ? (
                                      <div>
                                        <h5 className="text-capitalize f-15">
                                          Provided URL (your own website or
                                          third party website
                                        </h5>
                                        {bookings &&
                                        bookings.websiteUrl &&
                                        bookings.websiteUrl.length > 0 ? (
                                          bookings &&
                                          bookings.websiteUrl.map(
                                            (data, index) => {
                                              return (
                                                <React.Fragment key={index}>
                                                  <p className="form-control-plaintext gray-txt">
                                      ...
                                      <React.Fragment>
                                        <p className="gray-txt f-13 mb-2">
                                          Provide URL (your own website or third
                                          party website
                                        </p>
                                        <div className="row">
                                          <div className="col-sm-12 position-relative">
                                            <div className="addinput-control custom-lightinputbox position-relative">
                                              ...
                                              <button
                                                ...
                                                onClick={() => {
                                                  handleInputBoxDataUpdate(
                                                    values.bookingswebsiteUrl2,
                                                    values.bookingswebsiteUrl,
                                                    setFieldValue,
                                                    "bookingswebsiteUrl"
                                                  );
                                                  setFieldValue(
                                  ...
                                  <div className="mt-4">
                                    {editForm ? (
                                      <div>
                                        ...
                                        {bookings &&
                                        bookings.email &&
                                        bookings.email.length > 0 ? (
                                          bookings &&
                                          bookings.email.map((data, index) => {
                                            return (
                                              <React.Fragment key={index}>
                                                <p className="form-control-plaintext gray-txt">
                                                  {data}
                                          ...
                                          <div className="col-sm-12 position-relative">
                                            <div className="addinput-control custom-lightinputbox position-relative addinput-w-360">
                                              ...
                                              <button
                                                ...
                                                onClick={() => {
                                                  handleInputBoxDataUpdate(
                                                    values.bookingsemail2,
                                                    values.bookingsemail,
                                                    setFieldValue,
                                                    "bookingsemail"
                                                  );
                                                  setFieldValue(
                                  ...
                                  <div className="mt-4">
                                    {editForm ? (
                                      <div>
                                        ...
                                        bookings &&
                                        bookings.phoneNumber.length > 0 ? (
                                          bookings &&
                                          bookings.phoneNumber.map(
                                            (data, index) => {
                                              return (
                                                <React.Fragment key={index}>
                                                  <p className="form-control-plaintext gray-txt">
                                      ...
                                      <React.Fragment>
                                          ...
                                          <div className="col-sm-12 position-relative">
                                            <div className="addinput-control custom-lightinputbox position-relative addinput-w-360">
                                              ...
                                              <button
                                                ...
                                                onClick={() => {
                                                  handleInputBoxDataUpdate(
                                                    values.bookingsphoneNumber2,
                                                    values.bookingsphoneNumber,
                                                    setFieldValue,
                                                    "bookingsphoneNumber"
                                                  );
                                                  setFieldValue(
                                        ...
                                        <div className="row">
                                          ...
                                          <div className="col-sm-12 selectapplies-tag d-flex align-items-center flex-wrap">
                                            {values &&
                                              values.bookingsphoneNumber.map(
                                                (data, index) => {
                                                  return (
                                                    <React.Fragment key={index}>
                                                      <div className="d-flex flex-wrap justify-content-between align-items-center selectapplies-taglabel">
                                  ...
                                  {editForm ? (
                                    ...
                                    <div className="col-sm-12 d-flex flex-wrap mt-3">
                                      <div className="checkbox-setting custom-control custom-checkbox pink-checkbox pl-2 mr-4">
                                        <Field
                                          type="checkbox"
                                          name="isSocialAvailable"
                                          id="isSocialAvailable"
                                          className="custom-control-input"
                                        />
                                        <label
                                          className="custom-control-label gray-control-label f-13"
                                          htmlFor="isSocialAvailable"
                                        >
                                          Available
                                        </label>
                                      </div>
                                  ...
                                  <div className="mt-4">
                                    {editForm ? (
                                      <div>
                                        ...
                                        socialMedia.twitterUrl.length > 0 ? (
                                          socialMedia &&
                                          socialMedia.twitterUrl.map(
                                            (data, index) => {
                                              return (
                                                <React.Fragment key={index}>
                                                  <p className="form-control-plaintext gray-txt">
