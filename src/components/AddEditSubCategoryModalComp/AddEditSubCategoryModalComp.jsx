...
const AddEditSubCategoryModalComp = (props) => {
  ...
  let initialValues2 = {
    ...
    categoryId:
      categoryData &&
      categoryData.find((o) => o._id === selectedSubCategoryData.categoryId)
        ? selectedSubCategoryData.categoryId
        : "",
    menuId:
      menuData &&
      menuData.menuDetails.find((o) => o._id === selectedSubCategoryData.menuId)
        ? selectedSubCategoryData.menuId
        : "",
  };
